...
public extension UIView {
    ...
    func topAnchor(
        ...
        let useSafeArea = layoutOption.useSafeArea
        let useMargins = layoutOption.useMargins
        let topAnchor = thisTopAnchor(useSafeArea: useSafeArea, useMargins: useMargins)
        ...
        topAnchor.constraint(equalTo: superviewAxisYAnchor, constant: padding).isActive = true
        return self
    }
    ...
    func bottomAnchor(
        ...
        let useSafeArea = layoutOption.useSafeArea
        let useMargins = layoutOption.useMargins
        let bottomAnchor = thisBottomAnchor(useSafeArea: useSafeArea, useMargins: useMargins)
        let superviewAxisYAnchor: NSLayoutYAxisAnchor
        ...
        bottomAnchor.constraint(equalTo: superviewAxisYAnchor, constant: -padding).isActive = true
        return self
    }
    ...
    func centerY(in superview: UIView, layoutOption: AutoLayoutOption = .useSafeArea) -> Self {
        let useSafeArea = layoutOption.useSafeArea
        let useMargins = layoutOption.useMargins
        let centerYAnchor = thisCenterYAnchor(useSafeArea: useSafeArea, useMargins: useMargins)
        let superviewAnchor = superview.thisCenterYAnchor(useSafeArea: useSafeArea, useMargins: useMargins)
    ...
    func centerX(in superview: UIView, layoutOption: AutoLayoutOption = .useSafeArea) -> Self {
        let useSafeArea = layoutOption.useSafeArea
        let useMargins = layoutOption.useMargins
        let centerxAnchor = thisCenterXAnchor(useSafeArea: useSafeArea, useMargins: useMargins)
        let superviewAnchor = superview.thisCenterXAnchor(useSafeArea: useSafeArea, useMargins: useMargins)
    ...
    func widthAnchor(
        ...
        let useSafeArea = layoutOption.useSafeArea
        let useMargins = layoutOption.useMargins
        let widthAnchor = thisWidthAnchor(useSafeArea: useSafeArea, useMargins: useMargins)
        let superviewWidthAnchor = superview.thisWidthAnchor(useSafeArea: useSafeArea, useMargins: useMargins)
    ...
    func widthAnchor(
        ...
        let widthAnchor = thisWidthAnchor(useSafeArea: layoutOption.useSafeArea, useMargins: layoutOption.useMargins)
    ...
    func heightAnchor(
        ...
        let useSafeArea = layoutOption.useSafeArea
        let useMargins = layoutOption.useMargins
        let heightAnchor = thisHeightAnchor(useSafeArea: useSafeArea, useMargins: useMargins)
        let superviewHeightAnchor = superview.thisHeightAnchor(useSafeArea: useSafeArea, useMargins: useMargins)
    ...
    func heightAnchor(
        ...
        let heightAnchor = thisHeightAnchor(useSafeArea: layoutOption.useSafeArea, useMargins: layoutOption.useMargins)
